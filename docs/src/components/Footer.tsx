...
const Footer = () => {
  const footerLinkGroups = [
    ...
    },
    {
      title: "Community",
      links: [
        { title: "Donate", href: "https://darhkvoyd.me/sponsor" },
        {
          title: "Contribute",
  ...
  const footerLinkMiddleGroup = Math.ceil(footerLinkGroups.length / 2);
  return (
