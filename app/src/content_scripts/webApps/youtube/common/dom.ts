import {
  type ToppingsPanelHeader,
  type ToppingsMenuItem,
  type ToppingsMetadataSection,
  type ToppingsSectionItem,
} from "./interfaces";

export const createPanelHeader = (
  customHeader: ToppingsPanelHeader,
): HTMLDivElement => {
  const PanelHeaderExists =
    document.getElementById(customHeader.panelId) !== null;
...
export const createMenuItem = (
  customMenuItem: ToppingsMenuItem,
): HTMLDivElement => {
  const MenuItemExists =
    document.getElementById(customMenuItem.itemId) !== null;
  if (!MenuItemExists) {
    ...
    if (customMenuItem.itemIconPath !== undefined) {
      ...
      if (customMenuItem.itemClass !== undefined) {
        MenuItemIcon.className =
          "ytp-menuitem-icon " + customMenuItem.itemClass;
      } else {
    ...
    if (customMenuItem.itemLabel !== undefined) {
      ...
      if (customMenuItem.itemClass !== undefined) {
        MenuItemLabel.className =
          "ytp-menuitem-label " + customMenuItem.itemClass;
      } else {
        MenuItemLabel.className = "ytp-menuitem-label";
      }

      const MenuItemLabelText = document.createTextNode(
        customMenuItem.itemLabel,
      );
    ...
    if (customMenuItem.itemContent !== undefined) {
      ...
      if (customMenuItem.itemClass !== undefined) {
        MenuItemContent.className =
          "ytp-menuitem-content " + customMenuItem.itemClass;
      } else {
